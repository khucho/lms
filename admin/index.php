...
$courses = $co_con->getCourses();
$course_per_trainee = $co_con->coursePerTrainee();

$tcon = new TraineeController();
$trainee = $tcon->getTrainee();

$in_con = new InstructorController();
$instructor = $in_con->getInstructor();
									...
									<div class="col-sm-6">
										...
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php echo sizeof($trainee); ?></h1>
												<div class="mb-0">
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php echo sizeof($instructor); ?></h1>
												<div class="mb-0">
										...
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php echo sizeof($batch); ?></h1>
												<div class="mb-0">
								...
								<div class="card-body d-flex">
									<div class="align-self-center w-100">
										...
										<table class="table mb-0">
											...
											<tbody>
												<?php
												foreach($course_per_trainee as $cpt)
												{
													echo "<tr>";
													echo "<td>".$cpt['cname']."</td>";
							...
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0">
									...
									<tbody>
										<?php
											$count = 1;
										foreach ($batch_per_year as $bpy)
										{
											echo "<tr>";
											echo "<td>".$count++."</td>";
											echo "<td>".$bpy['year']."</td>";
											echo "<td>".$bpy['total']."</td>";
											echo "</tr>";
										}
										?>
									</tbody>
